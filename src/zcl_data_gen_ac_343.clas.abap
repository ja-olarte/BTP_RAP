class zcl_data_gen_ac_343 definition
  public
  final
  create public .
...
class zcl_data_gen_ac_343 implementation.
  ...
  method if_oo_adt_classrun~main.
    ...
    data: lt_acc_categ type table of ztb_acc_categ343,
          lt_catego    type table of ztb_catego343,
          lt_clientes  type table of ztb_clientes343,
          lt_clnts_lib type table of ztb_clnts_lib343,
          lt_libros    type table of ztb_libros343.
...
******** ztb_acc_categ343 ********
    ...
    delete from ztb_acc_categ343.
    insert ztb_acc_categ343 from table @lt_acc_categ.
...
******** ztb_catego343 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego343.
    insert ztb_catego343 from table @lt_catego.
...
******** ztb_clientes343 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes343.
    insert ztb_clientes343 from table @lt_clientes.
...
******** ztb_clnts_lib343
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib343.
    insert ztb_clnts_lib343 from table @lt_clnts_lib.
...
******** ztb_libros343 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros343.
    insert ztb_libros343 from table @lt_libros.
